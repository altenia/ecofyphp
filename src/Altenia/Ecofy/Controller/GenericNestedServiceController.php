 ...
 *
 */
class GenericNestedServiceController extends BaseController {
	 ...
	 * Constructor
	 */
	public function __construct($layoutName, $serviceInstanceName, $foreignKeyProperty, $modelName, $modelNamePlural = null) {
		parent::__construct();
