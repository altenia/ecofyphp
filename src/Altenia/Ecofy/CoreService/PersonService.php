 ...
 */
class PersonService extends BaseDataService {

    /**
     * Constructor
     */
    public function __construct($dao, $id = 'person')
    {
	 ...
	 * @return Response
	 */
	public function paginatePersons($queryParams, $page_size = 20)
	{
	    // @TODO: pending
		$query = \Person::query();
	 ...
	 */
	public function countPersons($criteria)
	{
	 ...
	 * @return Person
	 */
	public function findPersonByPK($pk)
	{
	 ...
	 */
	public function destroyPerson($pk)
	{
