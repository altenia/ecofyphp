...
class Category extends Model {
	 ...
	 * @var array
	 */
    protected $fillable = array('uuid','domain_sid','domain_id','owner_sid','created_by','created_dt','updated_by','updated_dt','update_counter','lang','parent_sid','type','name','code','description','image_url','position','params_text');
