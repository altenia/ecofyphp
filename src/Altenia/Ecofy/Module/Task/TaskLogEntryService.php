 ...
 */
class TaskLogEntryService extends BaseDataService {

    /**
     * Constructor
     */
    public function __construct($dao, $containerSvc = 'task', $id = 'task_log_entry')
    {
	 ...
	 * @return Response
	 */
	public function listTaskLogEntries($criteria, $sortParams = array(), $offset = 0, $limit=100)
	{
	 ...
	 * @return Response
	 */
	public function paginateTaskLogEntries($queryParams, $page_size = 20)
	{
	    // @TODO: pending
		$query = \TaskLogEntry::query();
	 ...
	 */
	public function countTaskLogEntries($criteria)
	{
	 ...
	 */
	public function createTaskLogEntry($data)
	{
		//print_r($data); die();

		$validator = TaskLogEntry::validator($data);
        if ($validator->passes()) {
            $record = new TaskLogEntry();
            $record->fill($data);
	 ...
	 * @return TaskLogEntry
	 */
	public function findTaskLogEntry($criteria)
	{
	 ...
	 * @return TaskLogEntry
	 */
	public function findTaskLogEntryByPK($pk)
	{
	 ...
	 */
	public function updateTaskLogEntry($pk, $data)
	{
		$validator = TaskLogEntry::validator($data, false);
        if ($validator->passes()) {
	 ...
	 * @return mixed null if successful, validation if validation error
	 */
	public function updateTaskLogEntryModel($model)
	{
	 ...
	 */
	public function destroyTaskLogEntry($pk)
	{
